...
public class DBConnection {
	...
	public ResultSet rs = null;			//结果集对象
     //驱动类的类名
	private static String dbClassName = "org.gjt.mm.mysql.Driver"; 
	private static String dbUrl = "jdbc:mysql://127.0.0.1:3306/software_development_practice?user=root&password=duli06271223&useUnicode=true&characterEncoding=UTF-8";
	private static String dbUser = "root";	//登录SQL Server的用户名
	private static String dbPwd = "duli06271223";
